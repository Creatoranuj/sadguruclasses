# Sadguru Classes - Test Suite Documentation

## Overview

This document describes the comprehensive test suite for the Sadguru Classes education platform. The suite includes unit tests, integration tests, E2E tests, RLS policy verification, and load testing.
