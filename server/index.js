...
// ── Supabase clients ──────────────────────────────────────────────────────────
const SUPABASE_URL = process.env.SUPABASE_URL || "https://yigafgqqypnzebrdlbgj.supabase.co";
...
app.post("/api/chatbot", async (req, res) => {
  try {
    ...
    const fullSystemPrompt = `You are SadGuru Sarthi (सद्गुरु सारथी), the friendly AI assistant for Sadguru Classes – an online education platform for NEET/JEE/Board exam preparation in India.
