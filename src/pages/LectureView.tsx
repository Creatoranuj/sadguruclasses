  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {showPlayer && currentLesson && (
        <div className="fixed inset-0 bg-black z-50 flex flex-col safe-area-inset" style={{ paddingTop: 'max(env(safe-area-inset-top), 28px)' }}>
          <button
      ...
      <header className="px-5 pt-4 pb-3">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate(-1)} className="text-primary min-h-[44px] min-w-[44px] flex items-center justify-center">
