...
const FloatingNotesButton = lazy(() => import("../components/notes/FloatingNotesButton"));
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background">
        <div className="relative">
          <img src={appLogo} alt="Loading" className="h-16 w-16 rounded-2xl sadguru-loader-logo" />
          <div className="absolute inset-0 rounded-2xl border-2 border-primary/40 sadguru-loader-ring" />
        </div>
              ...
              <div className="flex items-center justify-between gap-3 bg-gradient-to-r from-primary to-accent rounded-xl px-4 py-3 shadow-md">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <span className="text-sm font-medium truncate text-primary-foreground">
                    Install the Sadguru Classes app for a better experience
                  </span>
                </div>
