...
import infinityLogo from "../../assets/infinity-symbol.png";
 ...
 * - Shows Sadguru Classes branding instead of YouTube logo
 */
const EndScreenOverlay = ({ 
  ...
  return (
    <div 
      className="sadguru-end-screen absolute inset-0 flex flex-col items-center justify-center animate-in fade-in duration-300"
       ...
       <div className="flex items-center gap-3 mb-8">
         ...
         />
          <div className="text-white">
            <h3 className="text-xl font-bold">Sadguru Classes</h3>
