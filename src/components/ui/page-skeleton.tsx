...
export const LoadingSpinner = memo(({ 
  ...
  <div className="flex flex-col items-center justify-center gap-4 py-12">
    <div className="relative">
      <img src="/logo.png" alt="Loading" className="h-12 w-12 rounded-xl sadguru-loader-logo" />
      <div className="absolute inset-0 rounded-xl border-2 border-primary/40 sadguru-loader-ring" />
    </div>
