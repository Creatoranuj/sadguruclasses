        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium">
              ...
              <span>Classes 9-12 | JEE | NEET | Foundation</span>
            </div>

            {/* Dynamic Title */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-foreground">
              {data?.title || "Welcome to Sadguru Classes"}
            </h1>

            {/* Subheading */}
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 font-medium tracking-wide">
              India's Most Affordable Competitive Exam & Board Prep Platform
            </p>

            {/* Dynamic Subtitle */}
            <p className="text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0">
              {data?.subtitle || "Join Sadguru Classes for world-class education."}
            </p>
