      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="bg-card p-8 rounded-2xl border border-border shadow-lg space-y-4">
          ...
          <blockquote className="text-foreground text-lg italic leading-relaxed">
            "Sadguru Classes transformed my preparation. The faculty's dedication and structured approach helped me secure a top rank. I couldn't have done it without them!"
          </blockquote>
          <div>
